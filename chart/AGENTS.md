...
Chart source (OCI): `oci://ghcr.io/kbelokon/charts/readout` (version `0.12.0`).
...
helm upgrade --install readout oci://ghcr.io/kbelokon/charts/readout \
  --version 0.12.0 -f values.yaml --dry-run
helm upgrade --install readout oci://ghcr.io/kbelokon/charts/readout \
  --version 0.12.0 -f values.yaml
```
...
helm install readout oci://ghcr.io/kbelokon/charts/readout --version 0.12.0 -f values.yaml
```
