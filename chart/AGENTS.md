...
Chart source (OCI): `oci://ghcr.io/kbelokon/charts/readout` (version `0.11.4`).
...
helm upgrade --install readout oci://ghcr.io/kbelokon/charts/readout \
  --version 0.11.4 -f values.yaml --dry-run
helm upgrade --install readout oci://ghcr.io/kbelokon/charts/readout \
  --version 0.11.4 -f values.yaml
```
...
helm install readout oci://ghcr.io/kbelokon/charts/readout --version 0.11.4 -f values.yaml
```
