...
helm upgrade --install readout oci://ghcr.io/kbelokon/charts/readout \
  --version 0.11.0 -f my-values.yaml
```
...
helm install readout oci://ghcr.io/kbelokon/charts/readout --version 0.11.0 -f my-values.yaml
```
...
- **Chart values** — render the manifests and let the gates run:
  ...
  ```sh
  helm template readout oci://ghcr.io/kbelokon/charts/readout --version 0.11.0 -f my-values.yaml
  ```
