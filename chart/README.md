...
```sh
helm install readout oci://ghcr.io/kbelokon/charts/readout --version 0.8.1
```
...
helm install readout oci://ghcr.io/kbelokon/charts/readout --version 0.8.1 -f my-values.yaml
```
...
- **Chart values** — render the manifests and let the gates run:
  ...
  ```sh
  helm template readout oci://ghcr.io/kbelokon/charts/readout --version 0.8.1 -f my-values.yaml
  ```
