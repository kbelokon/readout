...
// action) + the Default/YAML/Events/Logs tabs (Logs active -- the SAME
...
// the optional per-container .ro-logtabs (active = green pill), and the
// .ro-logpre log block.
//
...
// block + a structured log line, the disabled-state notice, and the
...
type LogsData struct {
	...
	Name string
	// NameHead/NameTail/NameTitle mirror the detail title split:
	...
	// DownloadHref/DownloadIcon render the Download-logs title action
