...
func TestValidateClusterServerURL_LiteralIPs(t *testing.T) {
	cases := []struct {
		...
		{"scoped link-local v6", "https://[fe80::1%25en0]:6443", true},
		{"link-local multicast v4", "https://224.0.0.1:6443", true},
		{"scoped link-local multicast v6", "https://[ff02::1%25en0]:6443", true},
